...
- **Zwei Panel-Flächen.** Archiv (Baum, Suche) läuft nur noch als eigenes Fenster, Sitzung (ToDo, Befehle, Entwurf) ist angedockt und über den Knopf in der Titelzeile ablösbar. Fensterlabel `panel-<flaeche>-<project>`.
...
2. Archiv über den Archiv-Reiter öffnen — eigenes Fenster, nicht andockbar.
