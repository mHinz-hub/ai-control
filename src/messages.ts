...
const de = {
  ...
  projects: {
    ...
    archive: "Archiv",
    archiveNone: "kein Archiv — Panel ohne Archiv und Suche",
    changeDir: "Ändern …",
  ...
  modules: {
    ...
    archive: "Archiv",
    archiveDesc: "Archivieren, Archiv und Suche",
  ...
  panel: {
    ...
    tabEntwurf: "Entwurf",
    tabEntwurfKurz: "E",
    tabEntwurfTitle: "Entwurf der Sitzung",
    tabArchive: "Archiv",
    tabArchiveTitle: "Archiv-Notizen",
    tabSearch: "Suche",
  ...
  search: {
    ...
    spots: "{count} Fundstellen",
    showSpots: "Fundstellen zeigen",
    hideSpots: "Fundstellen ausblenden",
    tooMany: "Sehr viele Treffer — die Anfrage enger fassen (Phrase in Anführungszeichen, #tag).",
    fieldTitle: "im Titel",
  ...
  archive: {
    ...
    noPage: "Keine Archiv-Seite geladen.",
  ...
  epub: {
    ...
    night: "Dunkel lesen",
    day: "Hell lesen",
    smaller: "Kleiner setzen",
    larger: "Größer setzen",
    toc: "Inhalt ein- und ausklappen",
    paged: "Seitenweise lesen",
    marks: "Seitenumbrüche zeigen",
  },
};
...
const en: typeof de = {
  ...
  projects: {
    ...
    archive: "Archive",
    archiveNone: "no archive — panel without archive and search",
    changeDir: "Change …",
  ...
  modules: {
    ...
    archive: "Archive",
    archiveDesc: "archiving, archive and search",
    commit: "Commit dialog",
  ...
  panel: {
    ...
    tabEntwurf: "Draft",
    tabEntwurfKurz: "D",
    tabEntwurfTitle: "Session draft",
    tabArchive: "Archive",
    tabArchiveTitle: "Archive notes",
    tabSearch: "Search",
  ...
  search: {
    ...
    tooMany: "A great many hits — narrow the query (quoted phrase, #tag).",
  ...
  epub: {
    ...
    larger: "Larger type",
    toc: "Show or hide contents",
    paged: "Read page by page",
    marks: "Show page breaks",
  },
};
